//hak cipta (c) 2025 desvian project 
...
// se src/cryptonote_protocol/levin_notify.cpp
...
namespace config
{
  ...
  uint16_t const P2P_DEFAULT_PORT = 38567;
  uint16_t const RPC_DEFAULT_PORT = 39568;
  uint16_t const ZMQ_RPC_DEFAULT_PORT = 36569;
  boost::uuids::uuid const NETWORK_ID = { {
      0x21, 0x33, 0xFF, 0x75 , 0x61, 0x04 , 0x41, 0x41, 0x17, 0x31, 0x00, 0x82, 0x16, 0xA1, 0xA1, 0x14
    } }; // Bender's nightmare
  ...
  namespace testnet
  {
    ...
    uint16_t const P2P_DEFAULT_PORT = 28480;
    uint16_t const RPC_DEFAULT_PORT = 28081;
    uint16_t const ZMQ_RPC_DEFAULT_PORT = 27682;
    boost::uuids::uuid const NETWORK_ID = { {
